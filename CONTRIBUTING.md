...
This page describes how to contribute changes to Wasabi.

Please do not create a pull request without reading this guide first.

**Bug fixes**

Wasabi parses WSDL documents into endpoints, operations, namespaces, and types. If you
think you found a bug, the most useful input you can give us is: the WSDL that triggers it
(or a minimal fragment that reproduces it), the value Wasabi returned (e.g. from `endpoint`,
`operations`, `namespace`, or `operation_input_parameters`), and the value you expected.
...
WSDL, because the parsed output depends entirely on it.
...
* [Check that your Pull Request passes the build](https://github.com/savonrb/wasabi/actions/workflows/ci.yml)

**Improvements and feature requests**

If you have an idea for an improvement or a new feature, please feel free to
[create a new Issue](https://github.com/savonrb/wasabi/issues/new/choose) and describe your idea
